...
| `projects.md` | `src/content/projects/` | `/projects/<filename>`  |
...
| projects   | `title`, `description`, `status`, `stack`, `published` |
...
**Dates are read as UTC.** `published: 2026-08-21` parses as UTC midnight and is
formatted back in UTC, so it never slips a day in a negative-offset timezone.
